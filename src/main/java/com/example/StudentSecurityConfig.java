...
public class StudentSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
//	@Qualifier("com.example.service.StudentDetailServiceImpl")
//	@Qualifier("loadUserByUsername1")
//	private UserDetailsService studentDetailsService;
	private StudentDetailServiceImpl studentDetailsServiceImpl;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.antMatcher("/student/login")
		    .authorizeRequests() // 認可に関する設定
			.antMatchers("/student/login").permitAll() //「/」などのパスは全てのユーザに許可
	...
	public void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(studentDetailsServiceImpl)
