...
//	@Qualifier("com.example.service.CompanyDetailServiceImpl")
	@Autowired
//	private UserDetailsService companyMemberDetailsService;
	private CompanyDetailServiceImpl companyMemberDetailsServiceImpl;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.antMatcher("")
			...
			.antMatchers("/company").permitAll() //「/」などのパスは全てのユーザに許可
